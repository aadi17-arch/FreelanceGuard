...
import LiveChatDetails from "./pages/livechat/LiveChatDetails";
  ...
  <div className="min-h-[400px] flex flex-col items-center justify-center gap-6 p-12 bg-zinc-50/50 rounded-[2.5rem] border border-zinc-100 border-dashed animate-pulse">
    ...
    <div className="text-center space-y-3">
      ...
      <div className="flex flex-col items-center gap-1.5">
        <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest px-3 py-1 bg-emerald-50 rounded-full">
          Coming Soon
        </p>
        <p className="text-[11px] font-medium text-zinc-400 max-w-[240px]">
          We are currently hardening the security protocols for this feature.
        </p>
      </div>
    </div>
  </div>
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <DashboardLayout>
                  <OperationalPlaceholder title="Network Analytics" />
                </DashboardLayout>
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute>
                <DashboardLayout>
                  <OperationalPlaceholder title="Secure Messaging" />
                </DashboardLayout>
              </ProtectedRoute>
            }
          />
